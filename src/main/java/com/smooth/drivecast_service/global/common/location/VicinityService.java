 ...
 * GeoSearchService 기능을 통합하여 단순화
 **/
public interface VicinityService {

    /**
     * 반경 내 활성 사용자 조회 (재시도 지원)
     ...
     * @param maxRetries 최대 재시도 횟수 (사용자가 없을 때 재시도)
     * @param retryDelaysMs 재시도 지연 시간 목록 (밀리초)
     * @param refTime 기준 시각
    ...
    /**
     * 순수 지리적 검색 (GeoSearchService 기능 통합)
